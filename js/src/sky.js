var hint = [1,1,1,1,2,1,1,1,1,2,1,2,3,3,4,5,4,3,3,2,4,2,3,5,5,7,8,7,5,5,3,6,3,3,5,5,8,9,8,5,5,3,6,3,3,4,3,6,7,6,3,4,4,7,4,2,2,1,3,4,3,1,2,3,5,3,1,1,0,1,1,1,0,1,2,3,2];
...
function check()
{
    ...
    if (winFlag)
	{
		...
		document.getElementById("iloveyou").innerHTML = "<p><img src='/images/heart.png' alt='heart'></p><br /><br /><br /><br /><br /><p><img src='http://ozi1xtq8x.bkt.clouddn.com/images/yi.png' alt='heart'</p>";
